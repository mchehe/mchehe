YL.static = {
  /** “关于”信息 */
  softwareName: '赤焰官网', //软件名。请在此处填写您自己的网站名，如王小明的博客。
  version: "1.0.0", // 网站版本号
  iconBtnStart: 'html5', //主图标
  author: '赤焰',//作者
  contactInformation: 'chiyanwl@gmail.com',//联系方式
  officialWebsite: 'http://www.26an.cn',//软件官网
  welcome: '本网站UI由 YLUI 强力驱动\n更多信息：//ylui.yuri2.cn',//加载完毕控制台提示信息
  copyrightDetail: '赤焰网络科技',//版权详细信息
